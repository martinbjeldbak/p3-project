...
\newcommand{\tabelmedoverskrift}[2]{
\subsubsection{#1}
#2}

% old tabelmedoverskrift
...
\newcommand{\aktortabel}[3]{\tabelmedoverskrift{#1}{Formål: #2
...
\newcommand{\brugtabel}[4]{\tabelmedoverskrift{#1}{Brugsmønster: #2 
