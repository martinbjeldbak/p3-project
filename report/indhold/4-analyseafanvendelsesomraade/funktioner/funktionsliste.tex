...
\ourrow{Håndter opskrifter   }{ Opdatering    & Medium        }
\ourrow{Håndter favoritter   }{ Opdatering    & Medium        }
...
\ourtable{crawlingliste}{2}{Funktionsliste over den komplekse funktion ``crawling''.}
                                     {Egenskaber}
       {Navn              }{ Funktionstype & Kompleksitet  }{
