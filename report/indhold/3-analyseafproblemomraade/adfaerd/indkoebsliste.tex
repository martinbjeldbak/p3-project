...
\pdffig[0.8]{tilstandsdiagrammer/indkoebsliste}
  {Tilstandsdiagram for klassen indkøbsliste. Klassen har én tilstand (redigeres) og en afsluttende hændelse (\todo{hvilken slut hændelse?}, der fører klassen ud i sluttilstanden.}
