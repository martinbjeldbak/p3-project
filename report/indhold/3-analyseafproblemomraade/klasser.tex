...
Grundet den iterative arbejdsproces, er klasser undervejs blevet tilføjet og fjernet, og vi ønsker nu at kaste lys over baggrunden bag de valgte klasser. I gennem processen har vi også fravalgt klasser. Disse, med tilhørende beskrivelse, kan findes i \apref{ap:fravalgteklasser}. Herunder ses de valgte klasser, og begrundelse for at vi har dem med i vores model af problemområdet.
