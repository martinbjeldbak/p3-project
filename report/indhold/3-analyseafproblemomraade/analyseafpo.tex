...
% Problemområde
\input{indhold/3-analyseafproblemomraade/eksisterendesystemer} 
\input{indhold/3-analyseafproblemomraade/klasser}                %klasser + klassediagram
\input{indhold/3-analyseafproblemomraade/haendelser}             %hændelser, hændelsestabel, tilstandsdiagram
