...
Derudover er Ruby on Rails\cite{rubyonrailswiki}, der er et framework for programmeringssproget Ruby, blevet brugt til understøttelse af webudviklingen. Ruby on Rails gjorde det også muligt for os at kommunikere med databasen og benytte os af Model-View-Controller, hvilket er et udviklingsmønster, der bliver brugt i forbindelse med hjemmesider, som skal kommunikere med databaser.