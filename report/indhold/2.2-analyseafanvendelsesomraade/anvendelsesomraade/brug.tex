...
\subsection{Aktører}
\label{sec:aktoerer}
Vi har fundet 3 aktører, der vil kunne interagere med Foodl. Disse aktører kan ses i \todo{WTF?, hvem lavede en større sektion om til en table og brugte tableref til at reffere til den?}
\input{indhold/2.2-analyseafanvendelsesomraade/anvendelsesomraade/brug/aktoerbeskrivelse}
...
\input{indhold/2.2-analyseafanvendelsesomraade/anvendelsesomraade/brug/brugsmoenstre}
...
\input{indhold/2.2-analyseafanvendelsesomraade/anvendelsesomraade/brug/aktoertabel}
