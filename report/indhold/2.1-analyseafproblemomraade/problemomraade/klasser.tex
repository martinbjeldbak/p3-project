...
En klasse er en beskrivelse af en samling af objekter med samme struktur, adfærdsmønster og attributter \cite[s. ~51]{ooad}. Som det nævnt i indledningen til kapitlet \ref{chap:analyseafpo}, er et af målene med en analyse af problemområdet, at skabe et overblik over hvilke klasser og hændelser systemet skal have. Hændelser vil vi dog først komme nærmere ind på, i kommende section \ref{sec:haendelser}, men overblikket over hvilke klasser systemet skal have, kan skabes ved først at finde så mange klasser, som kunne være kandidater til systemet, som muligt, og dernæst at afgrænse disse, så kun de mest relevante klasser er tilbage. I vores tilfælde anvendte vi rigebilleder, som kan ses i \ref{}  ved hjælp af som vi vil modellere i problemområdet. Disse vælges
...
\input{indhold/2.1-analyseafproblemomraade/problemomraade/klasser/klassediagram}
