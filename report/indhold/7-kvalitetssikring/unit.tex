...
Dataudtrækkeren benyttede ikke Rails frameworket, hvorfor unittesten af dens funktion \methodref{CompareStrings} ikke blev lavet med Rspec Rails. Vi benyttede en ret simpel fremgangsmåde til at unitteste funktionen \methodref{CompareStrings}. Vi unittestede denne funktion I Ruby, ved at initialisere et array:
\begin{lstlisting}
test_cases = 
		[
		["aa12345", "aa67890", "aa"],
