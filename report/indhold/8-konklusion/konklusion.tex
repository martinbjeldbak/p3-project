...
Hvordan \Foodl{} fungerer på det tekniske niveau, er bekskrevet i \chapref{chap:implementering}. Til udvikling af systemet, anvendte vi den objektorienterede metode fra bogen ``Objektorienteret Analyse \& Design'' \cite{ooad}. Metoden er meget anvendelig i forhold til at analysere og designe objektorienterede systemer, \fx web-applikationer. 
